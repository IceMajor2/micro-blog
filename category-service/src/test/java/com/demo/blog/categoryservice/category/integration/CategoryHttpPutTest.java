package com.demo.blog.categoryservice.category.integration;

import com.demo.blog.categoryservice.category.Category;
import com.demo.blog.categoryservice.category.CategoryRepository;
...
import static com.demo.blog.categoryservice.assertion.AllAssertions.assertThatException;
import static com.demo.blog.categoryservice.category.datasupply.Constants.*;
import static com.demo.blog.categoryservice.util.RestRequestUtils.put;
...
public class CategoryHttpPutTest {
    ...
    @ParameterizedTest
    @MethodSource("com.demo.blog.categoryservice.datasupply.StringDataSupply#blankStrings")
    ...
    @ParameterizedTest
    @MethodSource("com.demo.blog.categoryservice.category.datasupply.CategoryDataSupply#tooLongRequestNames")
    ...
    @ParameterizedTest
    @DirtiesContext
    @MethodSource("com.demo.blog.categoryservice.category.datasupply.CategoryDataSupply#justRightLengthRequestName")

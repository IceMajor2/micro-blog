...
import static com.demo.blog.categoryservice.util.RestRequestUtils.get;
...
public class CategoryHttpGetTest {
    ...
    class GetByName {
        ...
        @ParameterizedTest
        @MethodSource("com.demo.blog.categoryservice.category.datasupply.CategoryDataSupply#validNames")
